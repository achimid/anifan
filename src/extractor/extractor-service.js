...
const getSubscribers = () => {
    return [
        ...
        { useProxy: false, skipImage: false, url: "https://www.crunchyroll.com/pt-br/simulcastcalendar?filter=premium", script: readScript("crunchyroll-script.js"), name: "Crunchyroll"},
